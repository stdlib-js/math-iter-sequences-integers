...
var iterIntegersSeq = require( './../lib' );
...
tape( 'main export is a function', function test( t ) {
	...
	t.strictEqual( typeof iterIntegersSeq, 'function', 'main export is a function' );
	t.end();
});
...
tape( 'the function returns an iterator protocol-compliant object which generates an interleaved integer sequence', function test( t ) {
	var expected;
	var actual;
	var it;
	var i;
	...
	for ( i = 0; i < 1000; i++ ) {
		...
		t.strictEqual( isInteger( actual.value ), true, 'returns expected value' );
...
tape( 'if an environment supports `Symbol.iterator`, the returned iterator is iterable', function test( t ) {
	...
	iterIntegersSeq = proxyquire( './../lib/main.js', {
